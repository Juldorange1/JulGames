...
const TT_SIZE: i32 = 15485863; // nombre premier proche de 2^24 (~139 Mo pour la TT,
                                // adapte a un usage cote navigateur du joueur ; la
                                // version hors-ligne pour construire le livre
                                // d'ouverture utilise une table bien plus grande)
