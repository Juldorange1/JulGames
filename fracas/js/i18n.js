...
const UI_STRINGS = {
  fr: {
    ...
    btnDefi: 'DEFI', btnDefiSub: '11 epreuves, 8 parcours + tes creations',
    ...
    volume: 'Volume',
    autoLabel: 'AUTO',
    btnBestiary: 'CODEX', btnBestiarySub: 'Personnages, ennemis, records',
    btnFeatures: 'FONCTIONNALITES', featuresTitle: 'FONCTIONNALITES',
    repTabChars: 'Personnages', repTabParkour: 'Parcours', repTabRecords: 'Records', repTabElements: 'Elements', repTabRules: 'Regles', repStats: 'Statistiques',
    repTestRoom: 'SALLE DE TEST', repMoney: 'Argent', repRecord: 'Record', repParkourNote: 'Personnage reserve aux defis de parcours',
    bestiaryTitle: 'CODEX',
    ...
    marketDecor_teleporter: 'Teleporteur', marketDecor_wall: 'Mur colore', marketDecor_wind: 'Vent', marketDecor_trampoline: 'Trampoline', marketDecor_boost: 'Boost de vitesse',
    marketTabShrink: 'Retirer une case', marketHint_shrink: 'Clique une case achetee (vide) pour la retirer : elle est remboursee.',
    marketHint_trampLand: "Clique maintenant la case libre ou le trampoline te fera atterrir (elle donne son sens).", marketTrampLanding: "Case d'atterrissage d'un trampoline",
    ...
    parkourTitle: 'Defis de parcours',
    parkourHint: "Atteins l'arrivee le plus vite possible. 4 personnages dedies (attaque = competence 1, touche de competence unique = competence 2). Piques, lasers et tourelles-pieges : chaque coup reduit ta vitesse (+25% rendus a mi-parcours). Trampolines, teleporteurs et boosts de vitesse t'aident. Jeu accelere.",
    parkourCreate: 'Creer un parcours', customParkoursTitle: 'Mes parcours personnalises',
    parkourNone: "Aucun parcours personnalise pour l'instant.",
    parkourLength: 'Longueur', parkourLength_1: 'Court', parkourLength_2: 'Moyen', parkourLength_3: 'Long',
    parkourDensity: 'Obstacles et pieges', parkourDensity_0: 'Peu', parkourDensity_1: 'Moyen', parkourDensity_2: 'Beaucoup',
    parkourZones: 'Zones (clique pour ajouter / retirer)', parkourGoal: 'ARRIVEE', parkourLabel: 'PARCOURS',
    hudSpeed: 'VITESSE', hudSpeedShort: 'vit.', hudProgress: 'Progression', parkourDefaultName: 'Parcours perso',
    parkourAllAbilities: 'toutes les competences',
    parkourHalfHeal: 'MI-PARCOURS : +25% VITESSE',
    customEdit: 'Modifier', edEditCombat: 'Modifier le defi', edEditParkour: 'Modifier le parcours',
    edTools: 'Outils', edZones: 'Zones', edReroll: 'Nouveau trace', edWall: 'Mur', edSpike: 'Piques', edLaser: 'Laser',
    edShooter: 'Tourelle', edBoost: 'Boost', edTrampoline: 'Trampoline', edErase: 'Gomme', edWalls: 'Murs', edAdded: 'Ajouts',
    edHint: 'Clic gauche : placer · Clic droit : effacer (n\'importe quoi) · ZQSD : se deplacer · Echap : quitter',
    edTooClose: 'Trop pres du depart', edBlocked: 'Emplacement bloque', edLimit: 'Limite atteinte',
    edWouldBlock: "Ce mur bloquerait l'arrivee",
    edTpExit: 'Clique la sortie du teleporteur', edSpeed: 'Vitesse du defi', edShape: 'Forme du trace', edShapeTurns: 'Avec virages', edShapeStraight: 'Tout droit',
    edWallS: 'Bloc', edWallH: 'Mur horizontal', edWallV: 'Mur vertical', edTeleporter: 'Teleporteur', edLaserV: 'Laser vertical', edLaserH: 'Laser horizontal',
    edDirection: 'Direction', edUndo: 'Annuler', edClear: 'Tout effacer',
  },
  en: {
    menuTitle: 'FRACAS',
    ...
    btnDefi: 'CHALLENGE', btnDefiSub: '11 trials, 8 courses + your own',
    ...
    volume: 'Volume',
    autoLabel: 'AUTO',
    btnBestiary: 'CODEX', btnBestiarySub: 'Characters, enemies, records',
    btnFeatures: 'FEATURES', featuresTitle: 'FEATURES',
    repTabChars: 'Characters', repTabParkour: 'Courses', repTabRecords: 'Records', repTabElements: 'Elements', repTabRules: 'Rules', repStats: 'Statistics',
    repTestRoom: 'TRAINING ROOM', repMoney: 'Money', repRecord: 'Record', repParkourNote: 'Character reserved for parkour challenges',
    bestiaryTitle: 'CODEX',
    ...
    marketDecor_trampoline: 'Trampoline', marketDecor_boost: 'Speed boost',
    marketTabShrink: 'Remove a cell', marketHint_shrink: 'Click a bought (empty) cell to remove it: it is refunded.',
    marketHint_trampLand: 'Now click the free cell where the trampoline will land you (it sets its direction).', marketTrampLanding: 'Trampoline landing cell',
    ...
    parkourTitle: 'Parkour challenges',
    parkourHint: 'Reach the finish as fast as possible. 4 dedicated characters (attack = skill 1, single ability key = skill 2). Spikes, lasers and trap turrets: every hit lowers your speed (+25% back at halfway). Trampolines, teleporters and speed boosts help. Sped-up game.',
    parkourCreate: 'Create a course', customParkoursTitle: 'My custom courses',
    parkourNone: 'No custom course yet.',
    parkourLength: 'Length', parkourLength_1: 'Short', parkourLength_2: 'Medium', parkourLength_3: 'Long',
    parkourDensity: 'Obstacles and traps', parkourDensity_0: 'Few', parkourDensity_1: 'Medium', parkourDensity_2: 'Many',
    parkourZones: 'Zones (click to add / remove)', parkourGoal: 'FINISH', parkourLabel: 'COURSE',
    hudSpeed: 'SPEED', hudSpeedShort: 'spd', hudProgress: 'Progress', parkourDefaultName: 'Custom course',
    parkourAllAbilities: 'all abilities',
    parkourHalfHeal: 'HALFWAY: +25% SPEED',
    customEdit: 'Edit', edEditCombat: 'Edit challenge', edEditParkour: 'Edit course',
    edTools: 'Tools', edZones: 'Zones', edReroll: 'New layout', edWall: 'Wall', edSpike: 'Spikes', edLaser: 'Laser',
    edShooter: 'Turret', edBoost: 'Boost', edTrampoline: 'Trampoline', edErase: 'Eraser', edWalls: 'Walls', edAdded: 'Added',
    edHint: 'Left click: place · Right click: erase · WASD: move · Esc: quit',
    edTooClose: 'Too close to the start', edBlocked: 'Spot blocked', edLimit: 'Limit reached',
    edWouldBlock: 'This wall would block the finish',
    edTpExit: 'Click the teleporter exit', edSpeed: 'Challenge speed', edShape: 'Course shape', edShapeTurns: 'With turns', edShapeStraight: 'Straight',
    edWallS: 'Block', edWallH: 'Horizontal wall', edWallV: 'Vertical wall', edTeleporter: 'Teleporter', edLaserV: 'Vertical laser', edLaserH: 'Horizontal laser',
    edDirection: 'Direction', edUndo: 'Undo', edClear: 'Clear all',
  },
};
...
const CHAR_I18N = {
  en: {
    ...
    2: { name: 'Nyx', epithet: 'The Jumper', attackLabel: 'Places a trampoline (3 max) · landing = 4 projectiles', a1Label: 'Swap with nearest turret', a2Label: 'Fire trail dash', a3Label: 'Rewind 1s' },
    ...
    10: { name: 'Gemini', epithet: 'The Two Orbs', attackLabel: 'Twin orb strike (charges)', a1Label: 'Shuffle the orbs', a2Label: 'Third orb (blocks everything, 6s)', a3Label: 'Freeze the two closest' },
